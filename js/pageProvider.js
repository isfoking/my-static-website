!function() {
    ...
    !function() {
        ...
        (l = m = m || {})[l.SIGN_TX = 0] = "SIGN_TX",
        l[l.SEND_BITCOIN = 1] = "SEND_BITCOIN",
        l[l.SEND_ORDINALS_INSCRIPTION = 2] = "SEND_ORDINALS_INSCRIPTION",
        l[l.SEND_ATOMICALS_INSCRIPTION = 3] = "SEND_ATOMICALS_INSCRIPTION";
        t(R, s.EventEmitter),
        j = i(R);
        var l = e(R)
          , g = (t(N, l),
        ...
        var P, k, j, l = new (e(C));
        function C() {
            var o, r, t, n, i, s, u, a, c, f, l, p, e = (0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}).maxListeners, e = void 0 === e ? 100 : e;
            return h(this, C),
            (o = P.call(this))._selectedAddress = null,
            o._network = null,
            o._isConnected = !1,
            o._initialized = !1,
            o._isUnlocked = !1,
            ...
            o._requestPromise = new _(0),
            o._bcm = new g(E),
            o.initialize = d(S().mark(function e() {
                var t, r, n;
            ...
            ,
            o._request = (p = d(S().mark(function e(t) {
                return S().wrap(function(e) {
                    for (; ; )
                        switch (e.prev = e.next) {
                        case 0:
            ...
            o.requestAccounts = d(S().mark(function e() {
                return S().wrap(function(e) {
                    for (; ; )
                        switch (e.prev = e.next) {
                        case 0:
            ...
            o.getNetwork = d(S().mark(function e() {
                return S().wrap(function(e) {
                    for (; ; )
                        switch (e.prev = e.next) {
                        case 0:
            ...
            o.switchNetwork = (l = d(S().mark(function e(t) {
                return S().wrap(function(e) {
                    for (; ; )
                        switch (e.prev = e.next) {
                        case 0:
            ...
            o.getAccounts = d(S().mark(function e() {
                return S().wrap(function(e) {
                    for (; ; )
                        switch (e.prev = e.next) {
                        case 0:
            ...
            o.getPublicKey = d(S().mark(function e() {
                return S().wrap(function(e) {
                    for (; ; )
                        switch (e.prev = e.next) {
                        case 0:
            ...
            o.getBalance = d(S().mark(function e() {
                return S().wrap(function(e) {
                    for (; ; )
                        switch (e.prev = e.next) {
                        case 0:
            ...
            o.getInscriptions = d(S().mark(function e() {
                var t, r, n = arguments;
                return S().wrap(function(e) {
                    for (; ; )
                        switch (e.prev = e.next) {
            ...
            o.signMessage = (f = d(S().mark(function e(t, r) {
                return S().wrap(function(e) {
                    for (; ; )
                        switch (e.prev = e.next) {
                        case 0:
            ...
            o.signData = (c = d(S().mark(function e(t, r) {
                return S().wrap(function(e) {
                    for (; ; )
                        switch (e.prev = e.next) {
                        case 0:
            ...
            o.sendBitcoin = (a = d(S().mark(function e(t, r, n) {
                return S().wrap(function(e) {
                    for (; ; )
                        switch (e.prev = e.next) {
                        case 0:
            ...
            o.sendInscription = (u = d(S().mark(function e(t, r, n) {
                return S().wrap(function(e) {
                    for (; ; )
                        switch (e.prev = e.next) {
                        case 0:
                            return e.abrupt("return", o._request({
                                ...
                                params: {
                                    ...
                                    inscriptionId: r,
                                    feeRate: null == n ? void 0 : n.feeRate,
                                    type: m.SEND_ORDINALS_INSCRIPTION
                                }
                            }));
                        case 1:
                        case "end":
            ...
            o.pushTx = (s = d(S().mark(function e(t) {
                return S().wrap(function(e) {
                    for (; ; )
                        switch (e.prev = e.next) {
                        case 0:
            ...
            o.signPsbt = (i = d(S().mark(function e(t, r) {
                return S().wrap(function(e) {
                    for (; ; )
                        switch (e.prev = e.next) {
                        case 0:
            ...
            o.signPsbts = (n = d(S().mark(function e(t, r) {
                return S().wrap(function(e) {
                    for (; ; )
                        switch (e.prev = e.next) {
                        case 0:
            ...
            o.pushPsbt = (t = d(S().mark(function e(t) {
                return S().wrap(function(e) {
                    for (; ; )
                        switch (e.prev = e.next) {
                        case 0:
            ...
            o.inscribeTransfer = (r = d(S().mark(function e(t, r) {
                return S().wrap(function(e) {
                    for (; ; )
                        switch (e.prev = e.next) {
                        case 0:
            ...
            o.getVersion = d(S().mark(function e() {
                return S().wrap(function(e) {
                    for (; ; )
                        switch (e.prev = e.next) {
                        case 0:
            ...
            o.isAtomicalsEnabled = d(S().mark(function e() {
                return S().wrap(function(e) {
                    for (; ; )
                        switch (e.prev = e.next) {
                        case 0:
            ...
            o.getBitcoinUtxos = d(S().mark(function e() {
                var t, r, n = arguments;
                return S().wrap(function(e) {
                    for (; ; )
                        switch (e.prev = e.next) {
            ...
            o.setMaxListeners(e),
            o.initialize(),
            o._pushEventHandlers = new b(v(o)),
            o
        }
        function L(e) {
            var t = this;
        ...
        function R() {
            ...
            ,
            u.onResponse = d(S().mark(function e() {
            ...
            u.onRequest = (t = d(S().mark(function e(t) {
                var r, n, o, i;
                return S().wrap(function(e) {
                    for (; ; )
                        switch (e.prev = e.next) {
